...
EXPORT_SYMBOL_GPL(nfc_parse_dt);
EXPORT_SYMBOL_GPL(configure_gpio);
EXPORT_SYMBOL_GPL(gpio_set_ven);
EXPORT_SYMBOL_GPL(gpio_free_all);
EXPORT_SYMBOL_GPL(nfc_misc_register);
EXPORT_SYMBOL_GPL(nfc_misc_unregister);
EXPORT_SYMBOL_GPL(nfc_dev_open);
